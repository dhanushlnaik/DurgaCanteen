            ...
            <Container>
                <Row>
                    <Col lg="3" md="6" className="m-b-30">
                        <h5 className="m-b-20">Contributor</h5>
                        <p>Dhanush Naik <br></br> Surabhi<br></br>Karthik</p>
                    </Col>
                    <Col lg="3" md="6" className="m-b-30">
                        <h5 className="m-b-20">Phone</h5>
                        <p>Reception :  +91 9989898989 <br />Office :  +207 235 7890</p>
                    </Col>
                    <Col lg="3" md="6" className="m-b-30">
                        <h5 className="m-b-20">Email</h5>
                        <p>Office :  <a href="#" className="link">info@durga.com</a> <br />Site :  <a href="#" className="link">durga@nitte.com</a></p>
                    </Col>
                    <Col lg="3" md="6">
                    ...
                    <Row>
                        <Col md="12">
                            <div className="d-flex font-14 justify-content-between">
                                <div className="m-t-10 m-b-10 copyright">All Rights Reserved by Team 06.</div>
